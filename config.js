...
var getConfig = module.exports = function () {
  return {
    ...
    gcloud: {
      projectId: process.env.GCLOUD_PROJECT || 'books-xx'
    },

    // Typically you will create a bucket with the same name as your project ID.
    cloudStorageBucket: process.env.CLOUD_BUCKET || 'books-xx',
    ...
    mongodb: {
      url: process.env.MONGO_URL || 'mongodb://xx:xx@ds023108.mlab.com:23108/db1',
    ...
    oauth2: {
      clientId: process.env.OAUTH_CLIENT_ID || 'xx-e4st8duje728gt47b4vo0lnihnc082p8.apps.xx.com',
      clientSecret: process.env.OAUTH_CLIENT_SECRET || '1R_M0ZKXRkWZ6T0Ty2OVsxhM',
