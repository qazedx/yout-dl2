...
var getConfig = module.exports = function () {
  return {
    ...
    gcloud: {
      projectId: process.env.GCLOUD_PROJECT || 'xx-xx-xx'
    },

    // Typically you will create a bucket with the same name as your project ID.
    cloudStorageBucket: process.env.CLOUD_BUCKET || 'xx-xx-xx',
    ...
    mongodb: {
      url: process.env.MONGO_URL || 'mongodb://xx:xx@xx.mlab.com:xx/xxxx',
      collection: process.env.MONGO_COLLECTION || 'xxxxx'
    },

    // The client ID and secret can be obtained by generating a new web
    // application client ID on Google Developers Console.
    oauth2: {
      clientId: process.env.OAUTH_CLIENT_ID || 'xx-xx.apps.googleusercontent.com',
      clientSecret: process.env.OAUTH_CLIENT_SECRET || 'xx',
      redirectUrl: process.env.OAUTH2_CALLBACK ||
        'http://localhost:xx/oauth2callback',
